...
header('location:index.php');
	...
	// código para la actualización de la dirección de facturación
...
// código para la actualización de la dirección de envío
	if(isset($_POST['shipupdate']))
	{
		...
		if($query)
		{
echo "<script>alert('Se actualizó la dirección de envío');</script>";
		}
	}
