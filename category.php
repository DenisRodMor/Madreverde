...
{
    ?>
                <a href="sub-category.php?scid=<?php echo $row['id'];?>" class="dropdown-toggle"><i class="icon fa fa-tree fa-fw"></i>
...
while($row=mysqli_fetch_array($sql))
{
    ?>
	    ...
	    <?php } ?>
	</div><!-- /.barra lateral-widget-cuerpo -->
</div><!-- /.widget de barra lateral -->
...
<!-- ============================================== COLOR: END ============================================== -->
	            	...
	            	</div><!-- /.filtro de barra lateral -->
	            </div><!-- /.contenedor de módulo de barra lateral -->
            </div><!-- /.barra lateral -->
			<div class='col-md-9'>
					<!-- ========================================== SECTION – HERO ========================================= -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="assets/images/banners/Categorias1.jpg" alt="" class="img-responsive">
			</div>
...
<?php } ?>	
						...
						</div><!-- /.panel de pestañas -->
						
				

				</div><!-- /.contenedor de resultados de búsqueda -->
