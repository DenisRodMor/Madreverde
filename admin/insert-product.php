...
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Ingrese el descuento del producto" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Ingres el costo de envio" class="span8 tip" required>
</div>
</div>
