					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Actualizar imagen 01 del producto</h3>
							</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen 01 actual del producto</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nueva imagen 01 del producto</label>
<div class="controls">
