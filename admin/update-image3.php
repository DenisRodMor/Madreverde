...
$_SESSION['msg']="La imagen del producto se actualizó correctamente !!";
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Actualizar imagen 03 del producto</h3>
							</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen 03 actual del producto</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nueva imagen 03 actual del producto</label>
<div class="controls">
